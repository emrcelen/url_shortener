...
public enum MessageCodes implements MessageCode{
    ...
    LOG_PERM_KEY_SAVE(0400),
    LOG_PERM_KEY_LIST_INFO(0401),
    LOG_PERM_KEY_ROLE_LIST_INFO(0402),
    LOG_PERM_KEY_ACTIVATED_LIST_INFO(0403),
    LOG_PERM_KEY_DEACTIVATED_LIST_INFO(0404),
    LOG_PERM_KEY_ACTIVATED_ROLE_LIST_INFO(0405),
    LOG_PERM_KEY_DEACTIVATED_ROLE_LIST_INFO(0406),
    // Exception:
    ...
    PERM_KEY_NOT_FOUND_EXCEPTION(-1700),
    PERM_KEY_ROLE_NOT_FOUND_EXCEPTION(-1701),
    PERM_KEY_EXPIRATION_DATE_EXCEPTION(-1702),
    // Developer Message:
    ...
    DEVELOPER_PERM_KEY_NOT_FOUND_MESSAGE(1700),
    DEVELOPER_PERM_KEY_ROLE_NOT_FOUND_MESSAGE(1701),
    DEVELOPER_PERM_KEY_EXPIRATION_DATE_MESSAGE(1702),
    DEVELOPER_PERM_KEY_REGISTER_NOT_FOUND_MESSAGE(1703),
