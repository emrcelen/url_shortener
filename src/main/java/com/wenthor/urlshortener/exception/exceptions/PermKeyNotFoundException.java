...
public class PermKeyNotFoundException extends RuntimeException{
    private final Locale locale;
    private final MessageCode messageCode;
    private final Integer exceptionCode;
    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    public PermKeyNotFoundException (String message, Locale locale, MessageCode messageCode) {
    ...
    public PermKeyNotFoundException (String message,String param, Locale locale, MessageCode messageCode) {
