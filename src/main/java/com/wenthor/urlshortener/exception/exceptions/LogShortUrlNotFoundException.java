...
public class LogShortUrlNotFoundException extends RuntimeException {
    private final Locale locale;
    private final MessageCode messageCode;
    private final Integer exceptionCode;
    private final Logger logger = LoggerFactory.getLogger(this.getClass());
    public LogShortUrlNotFoundException (String message, Locale locale, MessageCode messageCode) {
    ...
    public LogShortUrlNotFoundException (String message,String param, Locale locale, MessageCode messageCode) {
